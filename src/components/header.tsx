...
export default function Header() {
  ...
  return (
    <main className="w-full sticky top-0 z-50  max-w-[1192px] mx-auto">
      ...
      <div className="sticky z-100 w-full text-[#151531] text-[16px] font-bold mb-5">
              ...
              <div className="flex pt-[90px] px-4 h-screen w-full overflow-y-auto">
                <div className="flex flex-col gap-4 h-screen w-full">
                  ...
                  <div className="px-5 flex flex-col gap-4">
                    ...
                    <a className="flex items-center gap-2" href="/feature-launches">
                      <img
                        src="/navbar/feature-report.svg"
                        alt="Feature report"
                      />
